...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, InventoryReservedEvent> inventoryProducerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, InventoryReservedEvent> inventoryKafkaTemplate() {
